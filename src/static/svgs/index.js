...
export { ReactComponent as MusicActive } from './icon-music-active.svg';
...
export { ReactComponent as ChevronDown } from './icon-chevron-down.svg';
export { ReactComponent as ChevronLeft } from './icon-chevron-left.svg';
